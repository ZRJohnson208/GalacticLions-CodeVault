...
For those new to the robot programming space or robotics, it is higly recommended to review the [FTC Block Code](https://ftc-docs.firstinspires.org/programming_resources/blocks/Blocks-Tutorial.html) to get familiar with the robot coding language. This may also apply to returning team programmers.
